...
exports.createSubSection = async (req, res) => {
  try {
    ...
    console.log("Received sectionId:", sectionId); // Debugging
if (!sectionId || typeof sectionId !== "string") {
  return res.status(400).json({ success: false, message: "Invalid sectionId" });
    ...
    console.log("subsection ki id",SubSectionDetails._id);
...
console.log("Section updated is ", updatedSection)
...
exports.updateSubSection = async (req, res) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: "An error occurred while updating the sectionssss",
      message:error
    })
  }
}
